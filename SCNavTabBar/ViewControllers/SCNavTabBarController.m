...
- (void)viewInit
{
    ...
    if (self.isCustomFrame) {
          _navTabBar = [[SCNavTabBar alloc] initWithFrame:CGRectMake(DOT_COORDINATE, DOT_COORDINATE + _headerV.height, MAIN_SCREEN_WIDTH, NAV_TAB_BAR_HEIGHT) showArrowButton:_showArrowButton];
